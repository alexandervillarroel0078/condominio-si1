    ...
    <div class="from-orange-200">
        <form action="{{ route('users.update', ['user' => $user]) }}" method="POST">
            ...
            <div class="form-group mb-2">
                ...
                <select class="form-select" id="residente_id" name="residente_id" data-placeholder="Seleccione residente">
                    <option value="">--Seleccione residente--</option>
                    @foreach ($residentes as $residente)
                    <option value="{{ $residente->id }}" {{ $user->residente_id == $residente->id ? 'selected' : '' }}>
