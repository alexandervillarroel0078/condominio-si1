...
<div class="container-fluid px-4">
    <h1 class="mt-4">Sistema de Gestión de Condominioss</h1>
...
<div class="col-xl-4 col-md-6">
    <div class="card bg-danger text-white mb-4">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            ...
                            <a href="{{ route('roles.index') }}" class="list-group-item list-group-item-action">Roles y Permisos</a>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="adminInternaModal" tabindex="-1" aria-labelledby="adminInternaModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            <a href="{{ route('empleados.index') }}" class="list-group-item list-group-item-action">Lista de Empleados</a>
                            <a href="{{ route('cargos.index') }}" class="list-group-item list-group-item-action">Cargos de Empleados</a>
                            <a href="{{ route('residentes.index') }}" class="list-group-item list-group-item-action">Residentes</a>
        ...
        <div class="modal fade" id="finanzasModal" tabindex="-1" aria-labelledby="finanzasModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            ...
                            <a href="#" class="list-group-item list-group-item-action">Gastos del Condominio</a>
                            <a href="#" class="list-group-item list-group-item-action">Reservas de Áreas Comunes</a>
        ...
        <div class="modal fade" id="comunicacionModal" tabindex="-1" aria-labelledby="comunicacionModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            <a href="#" class="list-group-item list-group-item-action">Calificaciones de Servicios</a>
                            <a href="#" class="list-group-item list-group-item-action">Comunicados y Noticias</a>
                            <a href="#" class="list-group-item list-group-item-action">Reclamos y Sugerencias</a>
        ...
        <div class="modal fade" id="seguridadModal" tabindex="-1" aria-labelledby="seguridadModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            ...
                            <a href="#" class="list-group-item list-group-item-action">Seguridad y Vigilancia</a>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            ...
                            <a href="#" class="list-group-item list-group-item-action">Documentos del Condominio</a>
        ...
        <div class="modal fade" id="bitacoraModal" tabindex="-1" aria-labelledby="bitacoraModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="list-group">
                            <a href="{{ route('bitacora.index') }}" class="list-group-item list-group-item-action">Ver Bitácora</a>
                        </ul>
                    </div>
                </div>
            </div>
